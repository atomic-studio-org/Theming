    ...
    in
    {
      ...
      devShells = forEachSupportedSystem ({ pkgs }: {
        default = pkgs.mkShell {
          packages = (utility-flake.lib.${pkgs.system}.devShellPackages) ++ [(self.packages.${pkgs.system}.generate-xml)] ++ (with pkgs; [ go-task melange apko ]);
        };
      });
      ...
      packages = forEachSupportedSystem ({ pkgs }: rec {
        ...
        generate-xml = pkgs.writers.writeNuBin "gen-xml" ''
